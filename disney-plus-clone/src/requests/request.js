const APY_KEY = `3aa5d17bb4eb238fb55f5e9e51ac7489`;
const request = {
  ...
  fetchFantasy: `https://api.themoviedb.org/3/discover/movie?api_key=${APY_KEY}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_companies=2&with_genres=14`,
